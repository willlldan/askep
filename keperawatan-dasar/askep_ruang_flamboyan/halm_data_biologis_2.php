...
<main id="main" class="main">
    <?php include "keperawatan-dasar/askep_ruang_flamboyan/tab.php"; ?>
       ...
       <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate action="" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- 8. Thorax -->
                    <div class="row mb-2">
                        <label class="col-sm-12 text-primary"><strong>9. Thorax</strong></label>
                    </div>
                    <div class="row mb-2">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  ...
                  <?= $ro ?>><?= htmlspecialchars($existing_data['bentuk_dada'] ?? '') ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  name="pengembangan_dada" 
                  rows="1" 
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['pengembangan_dada'] ?? '') ?></textarea>
    </div>
</div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  name="perbandingan_dada" 
                  rows="1" 
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['perbandingan_dada'] ?? '') ?></textarea>
    </div>
</div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  name="suara_nafas_uraian" 
                  rows="1" 
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['suara_nafas_uraian'] ?? '') ?></textarea>
    </div>
</div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  ...
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['abnormal'] ?? '') ?></textarea>
    </div>
</div>
...
<div class="row mb-3 align-items-center">
    ...
    <div class="col-sm-4">
        <div class="input-group">
            <textarea class="form-control" 
                      ...
                      style="overflow:hidden; resize:none;" 
                      oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                      <?= $ro ?>><?= htmlspecialchars($existing_data['frekuensi_nafas'] ?? '') ?></textarea>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="perkusi_paru" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['perkusi_paru'] ?? '') ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="taktil_fremitus" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['taktil_fremitus'] ?? '') ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="kelainan_paru" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_paru'] ?? '') ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-4">
        <textarea class="form-control" name="s1_jantung" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['s1_jantung'] ?? '') ?></textarea>
    </div>
    <div class="col-sm-2 col-form-label"><strong>Terdapat pada</strong></div>
    <div class="col-sm-3">
        <textarea class="form-control" name="terdapat_pada_s1" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['terdapat_pada_s1'] ?? '') ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-4">
        <textarea class="form-control" name="s2_jantung" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['s2_jantung'] ?? '') ?></textarea>
    </div>
    <div class="col-sm-2 col-form-label"><strong>Terdapat pada</strong></div>
    <div class="col-sm-3">
        <textarea class="form-control" name="terdapat_pada_s2" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['terdapat_pada_s2'] ?? '') ?></textarea>
    </div>
</div>
                    <div class="row mb-2">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  ...
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['pulsasi_jantung'] ?? '') ?></textarea>
    </div>
</div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  ...
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_jantung'] ?? '') ?></textarea>
    </div>
</div>

                    <!-- 9. Abdomen -->
                    <div class="row mb-2">
                        <label class="col-sm-12 text-primary"><strong>10. Abdomen</strong></label>
                    </div>
...
<div class="row mb-3 align-items-center">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            <textarea class="form-control" name="bising_usus_kali" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['bising_usus_kali'] ?? '') ?></textarea>
...
<div class="row mb-3 align-items-center">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            ...
            <textarea class="form-control" name="benjolan_letak" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['benjolan_letak'] ?? '') ?></textarea>
        </div>
    </div>
</div>
...
<div class="row mb-3 align-items-center">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            <span class="input-group-text">Letak</span>
            <textarea class="form-control" name="nyeri_letak" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['nyeri_letak'] ?? '') ?></textarea>
        </div>
    </div>
</div>
...
<div class="row mb-3">
    <div class="col-sm-2 col-form-label"><strong>Lain-lain</strong></div>
    <div class="col-sm-9">
        <textarea class="form-control" name="kelainan_abdomen" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_abdomen'] ?? '') ?></textarea>
    </div>
</div>

                    <!-- 10. Genetalia -->
                    <div class="row mb-2">
                        <label class="col-sm-12 text-primary"><strong>11. Genetalia</strong></label>
                    </div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  name="kelainan_genetalia" 
                  rows="1" 
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_genetalia'] ?? '') ?></textarea>
    </div>
</div>

                    <!-- 11. Ekstremitas Atas -->
                    <div class="row mb-2">
                        <label class="col-sm-12 text-primary"><strong>12. Ekstremitas Atas</strong></label>
                    </div>
    ...
    <div class="col-sm-9">
        <div class="row">
            <div class="col-md-4 d-flex align-items-center">
                ...
                <textarea class="form-control" 
                          name="otot_tangan_kanan" 
                          rows="1" 
                          style="overflow:hidden; resize:none;" 
                          oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                          <?= $ro ?>><?= htmlspecialchars($existing_data['otot_tangan_kanan'] ?? '') ?></textarea>
            </div>
            <div class="col-md-4 d-flex align-items-center">
                <label class="me-2"><strong>Kiri</strong></label>
                <textarea class="form-control" 
                          name="otot_tangan_kiri" 
                          rows="1" 
                          style="overflow:hidden; resize:none;" 
                          oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                          <?= $ro ?>><?= htmlspecialchars($existing_data['otot_tangan_kiri'] ?? '') ?></textarea>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  name="kelainan_ekstremitas_atas" 
                  rows="1" 
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_ekstremitas_atas'] ?? '') ?></textarea>
    </div>
</div>

                    <!-- 12. Ekstremitas Bawah -->
                    <div class="row mb-2">
                        <label class="col-sm-12 text-primary"><strong>13. Ekstremitas Bawah</strong></label>
                    </div>
    ...
    <div class="col-sm-9">
        <div class="row">
            <div class="col-md-4 d-flex align-items-center">
                <label class="me-2"><strong>Kanan</strong></label>
                <textarea class="form-control" 
                          name="otot_kaki_kanan" 
                          rows="1" 
                          style="overflow:hidden; resize:none;" 
                          oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                          <?= $ro ?>><?= htmlspecialchars($existing_data['otot_kaki_kanan'] ?? '') ?></textarea>
            </div>
            <div class="col-md-4 d-flex align-items-center">
                <label class="me-2"><strong>Kiri</strong></label>
                <textarea class="form-control" 
                          ...
                          style="overflow:hidden; resize:none;" 
                          oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                          <?= $ro ?>><?= htmlspecialchars($existing_data['otot_kaki_kiri'] ?? '') ?></textarea>
            </div>
        </div>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  name="kelainan_ekstremitas_bawah" 
                  rows="1" 
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_ekstremitas_bawah'] ?? '') ?></textarea>
    </div>
</div>

                    <!-- 13. Kulit -->
                    <div class="row mb-2">
                        <label class="col-sm-12 text-primary"><strong>14. Kulit</strong></label>
                    </div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  ...
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['warna_kulit'] ?? '') ?></textarea>
    </div>
</div>
                    <div class="row mb-2">
...
<div class="row mb-3 align-items-center">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            ...
            <textarea class="form-control" name="pada_daerah" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['pada_daerah'] ?? '') ?></textarea>
        </div>
    </div>
</div>
...
<div class="row mb-3 align-items-center">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            <span class="input-group-text">Pada Daerah</span>
            <textarea class="form-control" name="pada_daerah_luka" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['pada_daerah_luka'] ?? '') ?></textarea>
        </div>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="karakteristik_luka" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= htmlspecialchars($existing_data['karakteristik_luka'] ?? '') ?></textarea>
    </div>
</div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  ...
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_kulit'] ?? '') ?></textarea>
    </div>
</div>
    ...
    <div class="col-sm-9">
        <textarea class="form-control" 
                  ...
                  style="overflow:hidden; resize:none;" 
                  oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" 
                  <?= $ro ?>><?= htmlspecialchars($existing_data['kelainan_kuku'] ?? '') ?></textarea>
    </div>
</div>
                    <!-- F. Data Penunjang -->
                    <div class="row mb-2">
...
<script>
    ...
    // Fungsi helper untuk gaya textarea
    const taStyle = "overflow:hidden; resize:none; min-height:30px;";
    const taOnInput = "this.style.height='auto'; this.style.height=this.scrollHeight+'px';";
    ...
    function tambahRowLab(data = null) {
        ...
        row.innerHTML = `
            ...
            <td><textarea class="form-control form-control-sm" name="lab[${index}][pemeriksaan]" rows="1" style="${taStyle}" oninput="${taOnInput}" ${ro}>${data?.pemeriksaan ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="lab[${index}][hasil]" rows="1" style="${taStyle}" oninput="${taOnInput}" ${ro}>${data?.hasil ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="lab[${index}][nilai_normal]" rows="1" style="${taStyle}" oninput="${taOnInput}" ${ro}>${data?.nilai_normal ?? ''}</textarea></td>
    ...
    function tambahRowObat(data = null) {
        ...
        row.innerHTML = `
            <td class="text-center align-middle">${index}</td>
            <td><textarea class="form-control form-control-sm" name="obat[${index}][jenis_obat]" rows="1" style="${taStyle}" oninput="${taOnInput}" ${ro}>${data?.jenis_obat ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="obat[${index}][dosis]" rows="1" style="${taStyle}" oninput="${taOnInput}" ${ro}>${data?.dosis ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="obat[${index}][kegunaan]" rows="1" style="${taStyle}" oninput="${taOnInput}" ${ro}>${data?.kegunaan ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="obat[${index}][cara_pemberian]" rows="1" style="${taStyle}" oninput="${taOnInput}" ${ro}>${data?.cara_pemberian ?? ''}</textarea></td>
            ${!isReadonly ? `<td class="text-center align-middle"><button type="button" class="btn btn-danger btn-sm" onclick="hapusRow(this)">x</button></td>` : ''}
        `;
        tbody.appendChild(row);
        rowObatCount++;
