...
$page = $_GET['page'] ?? '';
$parts = explode('/', $page);
$jeniskeperawatan = $parts[1] ?? 'resume_poli_rsal';
$titles = [
...
<div class="pagetitle">
    <h1><strong><?= $titles[$jeniskeperawatan] ?? 'Resume Poli RSAL' ?></strong></h1>
</div>
<br>
<ul class="nav nav-tabs custom-tabs">
    ...
    foreach ($tabs as $tab):
        ...
        $url = "index.php?page=keperawatan-dasar/resume_poli_rsal&tab={$tab}";
