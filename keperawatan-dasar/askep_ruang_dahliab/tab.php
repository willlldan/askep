...
$page = $_GET['page'] ?? '';
$parts = explode('/', $page);
$jeniskeperawatan = $parts[1] ?? 'askep_ruang_dahlia';
$titles = [
    'askep_ruang_damar' => 'Askep Keperawatan Dasar Ruang Damar',
    'askep_ruang_angsana' => 'Askep Keperawatan Dasar Ruang Angsana',
    'askep_ruang_dahlia' => 'Askep Keperawatan Dasar Ruang Dahlia A',
    'askep_ruang_dahliab' => 'Askep Keperawatan Dasar Ruang Dahlia B',
...
<ul class="nav nav-tabs custom-tabs">
    ...
    foreach ($tabs as $tab):
        ...
        $url = "index.php?page=keperawatan-dasar/askep_ruang_dahliab&tab={$tab}";
