        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="" method="POST">
                    ...
                    <!-- ===================== TABEL DIAGNOSA ===================== -->
                    <p class="fw-bold mb-2">10. Diagnosa Keperawatan</p>
                    ...
                    <!-- ===================== TABEL PERENCANAAN ===================== -->
                    <p class="fw-bold mb-2">11. Perencanaan Keperawatan</p>
                    ...
                    <!-- ===================== TABEL IMPLEMENTASI ===================== -->
                    <p class="fw-bold mb-2">12. Implementasi Keperawatan</p>
                    ...
                    <!-- ===================== TABEL EVALUASI ===================== -->
                    <p class="fw-bold mb-2">13. Evaluasi Keperawatan</p>
