...
<ul class="nav nav-tabs custom-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link <?= ($_GET['tab'] ?? '') == 'lp_imunisasi' ? 'active' : '' ?>"
            href="index.php?page=anak/lp_imunisasi&jenisanak=<?= $jenisanak ?>&tab=lp_imunisasi<?php if($submission_id) echo '&submission_id=' . $submission_id; ?>">
    ...
    <li class="nav-item">
        <a class="nav-link <?= ($_GET['tab'] ?? '') == 'poli_imunisasi' ? 'active' : '' ?>"
            href="index.php?page=anak/poli_imunisasi&jenisanak=<?= $jenisanak ?>&tab=poli_imunisasi<?php if($submission_id) echo '&submission_id=' . $submission_id; ?>">
