        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="" method="POST">
                    ...
                    <!-- ===================== TABEL DIAGNOSA ===================== -->
                    <p class="text-primary fw-bold mb-2">E. Diagnosa Keperawatan Prioritas</p>
                    ...
                    <!-- ===================== TABEL PERENCANAAN ===================== -->
                    <p class="text-primary fw-bold mb-2">F. Perencanaan Keperawatan</p>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="no_registrasi_perencanaan"
                                value="<?= val('no_registrasi', $existing_data) ?>" <?= $ro ?>>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ruangan_perencanaan"
                                value="<?= val('ruangan', $existing_data) ?>" <?= $ro ?>>
                        </div>
                    </div>
                    ...
                    <!-- ===================== TABEL IMPLEMENTASI ===================== -->
                    <p class="text-primary fw-bold mb-2">G. Implementasi Keperawatan</p>
                    ...
                    <!-- ===================== TABEL EVALUASI ===================== -->
                    <p class="text-primary fw-bold mb-2">H. Evaluasi Keperawatan</p>
