...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="nama_anak" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('nama_anak', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="ttl_umur" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('ttl_umur', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="agama" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('agama', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="alamat" rows="2" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('alamat', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="diagnosa_medik" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('diagnosa_medik', $existing_data) ?></textarea>
    </div>
</div>
                       <div class="row mb-2">
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="nama_ayah" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('nama_ayah', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="usia_ayah" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('usia_ayah', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="pendidikan_ayah" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('pendidikan_ayah', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea name="pekerjaan_ayah" class="form-control" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('pekerjaan_ayah', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="agama_ayah" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('agama_ayah', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea name="alamat_ayah" class="form-control" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('alamat_ayah', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    <label class="col-sm-2 col-form-label"><strong>a. Nama :</strong></label>
    <div class="col-sm-9">
        <textarea class="form-control" name="nama_ibu" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('nama_ibu', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    <label class="col-sm-2 col-form-label"><strong>b. Usia :</strong></label>
    <div class="col-sm-9">
        <textarea class="form-control" name="usia_ibu" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('usia_ibu', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    <label class="col-sm-2 col-form-label"><strong>c. Pendidikan :</strong></label>
    <div class="col-sm-9">
        <textarea class="form-control" name="pendidikan_ibu" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('pendidikan_ibu', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    <label class="col-sm-2 col-form-label"><strong>d. Pekerjaan/Sumber Penghasilan :</strong></label>
    <div class="col-sm-9">
        <textarea name="pekerjaan_ibu" class="form-control" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('pekerjaan_ibu', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    <label class="col-sm-2 col-form-label"><strong>e. Agama :</strong></label>
    <div class="col-sm-9">
        <textarea class="form-control" name="agama_ibu" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('agama_ibu', $existing_data) ?></textarea>
    </div>
</div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label"><strong>f. Alamat :</strong></label>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="prenatal_tt" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('prenatal_tt', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="goldar_ibu" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('goldar_ibu', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="goldar_ayah" rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('goldar_ayah', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="tempat_lahir" rows="2" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('tempat_lahir', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="jenis_persalinan" rows="2" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('jenis_persalinan', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="penolong" rows="2" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('penolong', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="kondisi_bayi" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('kondisi_bayi', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea name="gangguan_lahir" class="form-control" rows="5" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('gangguan_lahir', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="penyakit" rows="4" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('penyakit', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="umur_penyakit" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('umur_penyakit', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="obat_oleh" rows="2" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('obat_oleh', $existing_data) ?></textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" name="kecelakaan" rows="1" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" <?= $ro ?>><?= val('kecelakaan', $existing_data) ?></textarea>
    </div>
</div>
    ...
    // Fungsi bantu untuk auto-resize textarea
    ...
    function tambahRowObat(data = null) {
        ...
        row.innerHTML = `
            ...
            <td><textarea class="form-control form-control-sm" name="obat[${index}][nama]" style="resize:none; overflow:hidden;" oninput="autoExpand(this)" ${isReadonly ? 'readonly' : ''}>${data?.nama ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="obat[${index}][usia]" style="resize:none; overflow:hidden;" oninput="autoExpand(this)" ${isReadonly ? 'readonly' : ''}>${data?.usia ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="obat[${index}][hubungan]" style="resize:none; overflow:hidden;" oninput="autoExpand(this)" ${isReadonly ? 'readonly' : ''}>${data?.hubungan ?? ''}</textarea></td>
            <td><textarea class="form-control form-control-sm" name="obat[${index}][status]" style="resize:none; overflow:hidden;" oninput="autoExpand(this)" ${isReadonly ? 'readonly' : ''}>${data?.status ?? ''}</textarea></td>
        ...
        // Menyesuaikan tinggi saat pertama kali dimuat jika ada data
