...
if (isset($_POST['submit'])) {
    ...
    if ($mysqli->query($sql) === TRUE) {
        echo "<script>alert('Dokumen Masuk berhasil ditambah.')</script>";
    } else {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="tgl_masuk_dok" name="tgl_masuk_dok" required>
                        <div class="invalid-feedback">
                            Harap isi Tanggal Dokumen.
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="tgl_terima_dok" name="tgl_terima_dok" required>
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="asal_dokumen" required>
                        <div class="invalid-feedback">
