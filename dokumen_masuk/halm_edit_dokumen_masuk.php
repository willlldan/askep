...
if (isset($_GET['no_dokumen'])) {
    ...
    echo "<script>" .
        "window.location.href='index.php?page=dokumen_masuk&item=tampil_dokumen_masuk';" .
        "</script>";
}
...
if (isset($_POST['submit'])) {
    ...
    $tgl_terima_dok = $_POST['tgl_terima_dok'];
    ...
    if (isset($_FILES['file']['name']) && !empty($_FILES['file']['name'])) {
        $target_dir = "dokumen_masuk/uploads/";
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
            echo "Dokumen Masuk berhasil diedit.";
        } else {
    ...
    if (isset($_POST['remove_file']) && $_POST['remove_file'] === '1') {
        ...
        if (!empty($row['file'])) {
            $file_path = "dokumen_masuk/uploads/" . $row['file'];
    ...
    if ($mysqli->query($sql) === TRUE) {
        echo "<script>alert('Dokumen Masuk berhasil diedit.')</script>";
            ...
            <div class="card-body">
                ...
                <!-- Bagian No Dokumen -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" name="status_tindakan" required>
                                <option value="Proses" <?php if ($row['status_tindakan'] == 'Proses') echo 'selected'; ?>>Proses</option>
                                <option value="Selesai" <?php if ($row['status_tindakan'] == 'Selesai') echo 'selected'; ?>>Selesai</option>
                                <option value="Arsip" <?php if ($row['status_tindakan'] == 'Arsip') echo 'selected'; ?>>Arsip</option>
                            </select>
                            <div class="invalid-feedback">
                                Harap isi Status Tindakan.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="tgl_masuk_dok" name="tgl_masuk_dok" required value="<?= $row['tgl_masuk_dok']; ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="tgl_terima_dok" name="tgl_terima_dok" required value="<?= $row['tgl_terima_dok']; ?>">
                            <div class="invalid-feedback">
                                Harap isi Tanggal Terima Dokumen.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="asal_dokumen" name="asal_dokumen" required value="<?= $row['asal_dokumen']; ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <?php if (!empty($row['file'])) : ?>
                                <p><a href="dokumen_masuk/uploads/<?php echo $row['file']; ?>" target="_blank"><?php echo $row['file']; ?></a>
                        ...
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            function removeFile(fileName) {
                                if (confirm('Apakah Anda yakin ingin menghapus file ini?')) {
                                    ...
                                    var fileLink = document.querySelector('a[href="dokumen_masuk/uploads/' + fileName + '"]');
