...
$page = $_GET['page'] ?? '';
$parts = explode('/', $page);
$jeniskeperawatan = $parts[1] ?? 'askep_ruang_perawatan';
$titles = [
...
<div class="pagetitle">
    <h1><strong><?= $titles[$jeniskeperawatan] ?? 'Askep Keperawatan Dasar Ruang perawatan' ?></strong></h1>
</div>
<br>
<ul class="nav nav-tabs custom-tabs">
    ...
    foreach ($tabs as $tab):
        ...
        $url = "index.php?page=askep/askep_ruang_flamboyan&tab={$tab}";
