...
<head>
    ...
    <title>Laporan Peminjaman Dokumen Personel</title>
    <style>
        table,
        td,
        th {
...
<body>
    <div class="container">
        ...
        <h2 class="text-center my-3" style="border-top: 2px solid black;">Laporan Peminjaman Dokumen Personel</h2>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
              ...
              $result = $mysqli->query("SELECT * FROM tbl_peminjaman_dok_personel WHERE tgl_pinjam >= '$dari' AND tgl_pinjam <= '$sampai'  ORDER BY id_peminjaman_dok_personel DESC");
