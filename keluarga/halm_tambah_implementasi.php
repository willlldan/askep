        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title mb-1"><strong>Implementasi Keperawatan</strong></h5>
                ...
                <div class="row mb-3">
                    <label for="pertemuan" class="col-sm-2 col-form-label"><strong>Pertemuan</strong></label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="pertemuan">

                            <!-- comment -->
                                <textarea class="form-control mt-2" name="commentpertemuan" id="commentpertemuan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
