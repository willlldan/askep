        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="" method="POST">
                    ...
                    <!-- ===================== TABEL DIAGNOSA ===================== -->
                    <p class="text-primary fw-bold mb-2">11. Diagnosa Keperawatan</p>
                    ...
                    <!-- ===================== TABEL INTERVENSI ===================== -->
                    <p class="text-primary fw-bold mb-2">12. Intervensi Keperawatan</p>
                    ...
                    <!-- ===================== TABEL IMPLEMENTASI ===================== -->
                    <p class="text-primary fw-bold mb-2">13. Implementasi Keperawatan</p>
                    ...
                    <!-- ===================== TABEL EVALUASI ===================== -->
                    <p class="text-primary fw-bold mb-2">14. Evaluasi Keperawatan</p>
