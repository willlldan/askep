    ...
    <section class="section dashboard">
                     ...
                     <div class="row mb-2">
                        <label class="col-sm-7 col-form-label text-primary">
                            <strong>C.  Implementasi Pre dan Post Operasi</strong>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-sm-9 offset-sm-2">
                       ...
                       <div class="row mb-3">
    <label for="paraf" class="col-sm-2 col-form-label"><strong>Paraf</strong></label>

    <div class="col-sm-9">
        <!-- Checkbox Paraf -->
        <div class="form-check mt-2">
            <input class="form-check-input" type="checkbox" id="paraf" name="paraf">
            <label class="form-check-label" for="paraf">
                Paraf
            </label>
        </div>

        <!-- Comment -->
        <textarea class="form-control mt-2" id="commentparaf" rows="2"
