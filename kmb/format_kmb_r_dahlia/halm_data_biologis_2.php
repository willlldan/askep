...
<main id="main" class="main">
    <?php include "kmb/format_kmb_r_dahlia/tab.php"; ?>
            ...
            <div class="card-body">
                <form class="needs-validation" novalidate action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('pengembangan_dada',$existing_data) ?></textarea>    
                            </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-2 col-form-label">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea name="perkusi_paru" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('perkusi_paru',$existing_data) ?></textarea>    
                            </div>
                    </div>
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="suara_nafas" value="teratur" id="suara_nafas_teratur" <?= $ro_disabled ?> <?= ($existing_data['suara_nafas'] ?? '') === 'teratur' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="suara_nafas_teratur">Normal</label>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="input-group">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea name="kelainan_ekstremitas_atas" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('kelainan_ekstremitas_atas',$existing_data) ?></textarea>    
                            </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pembengkakan_atas" value="ya" id="pembengkakan_atas_ya" <?= $ro_disabled ?> <?= ($existing_data['pembengkakan_atas'] ?? '') === 'ya' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="pembengkakan_atas_ya">Ya</label>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pembengkakan_atas" value="tidak" id="pembengkakan_atas_tidak" <?= $ro_disabled ?> <?= ($existing_data['pembengkakan_atas'] ?? '') === 'tidak' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="pembengkakan_atas_tidak">Tidak</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="kelembaban_atas" value="lembab" id="kelembaban_atas_lembab" <?= $ro_disabled ?> <?= ($existing_data['kelembaban_atas'] ?? '') === 'lembab' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="kelembaban_atas_lembab">Lembab</label>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="kelembaban_atas" value="kering" id="kelembaban_atas_kering" <?= $ro_disabled ?> <?= ($existing_data['kelembaban_atas'] ?? '') === 'kering' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="kelembaban_atas_kering">Kering</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="temperatur_atas" value="panas" id="temperatur_atas_panas" <?= $ro_disabled ?> <?= ($existing_data['temperatur_atas'] ?? '') === 'panas' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="temperatur_atas_panas">Panas</label>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="temperatur_atas" value="dingin" id="temperatur_atas_dingin" <?= $ro_disabled ?> <?= ($existing_data['temperatur_atas'] ?? '') === 'dingin' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="temperatur_atas_dingin">Dingin</label>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea name="kelainan_ekstremitas_bawah" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('kelainan_ekstremitas_bawah',$existing_data) ?></textarea>    
                            </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pembengkakan_bawah" value="ya" id="pembengkakan_bawah_ya" <?= $ro_disabled ?> <?= ($existing_data['pembengkakan_bawah'] ?? '') === 'ya' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="pembengkakan_bawah_ya">Ya</label>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pembengkakan_bawah" value="tidak" id="pembengkakan_bawah_tidak" <?= $ro_disabled ?> <?= ($existing_data['pembengkakan_bawah'] ?? '') === 'tidak' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="pembengkakan_bawah_tidak">Tidak</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="varises_bawah" value="ada" id="varises_bawah_ada" <?= $ro_disabled ?> <?= ($existing_data['varises_bawah'] ?? '') === 'ada' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="varises_bawah_ada">Ada</label>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="varises_bawah" value="tidak" id="varises_bawah_tidak" <?= $ro_disabled ?> <?= ($existing_data['varises_bawah'] ?? '') === 'tidak' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="varises_bawah_tidak">Tidak</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kelembaban_bawah" value="lembab" id="kelembaban_bawah_lembab" <?= $ro_disabled ?> <?= ($existing_data['kelembaban_bawah'] ?? '') === 'lembab' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="kelembaban_bawah_lembab">Lembab</label>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kelembaban_bawah" value="kering" id="kelembaban_bawah_kering" <?= $ro_disabled ?> <?= ($existing_data['kelembaban_bawah'] ?? '') === 'kering' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="kelembaban_bawah_kering">Kering</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="temperatur_bawah" value="panas" id="temperatur_bawah_panas" <?= $ro_disabled ?> <?= ($existing_data['temperatur_bawah'] ?? '') === 'panas' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="temperatur_bawah_panas">Panas</label>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="temperatur_bawah" value="dingin" id="temperatur_bawah_dingin" <?= $ro_disabled ?> <?= ($existing_data['temperatur_bawah'] ?? '') === 'dingin' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="temperatur_bawah_dingin">Dingin</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <textarea name="kelainan_genetalia" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('kelainan_genetalia',$existing_data) ?></textarea>    
                                </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kelembaban_kulit" value="lembab" id="kelembaban_kulit_lembab" <?= $ro_disabled ?> <?= ($existing_data['kelembaban_kulit'] ?? '') === 'lembab' ? 'checked' : '' ?>>
                            ...
                            <div class="col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kelembaban_kulit" value="kering" id="kelembaban_kulit_kering" <?= $ro_disabled ?> <?= ($existing_data['kelembaban_kulit'] ?? '') === 'kering' ? 'checked' : '' ?>>
                        ...
                        <div class="row mb-3">
                            ...
                            <textarea name="nervus1_penciuman" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('nervus1_penciuman',$existing_data) ?></textarea>    
                                </div>
                        </div>    
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <textarea name="nervus2_penglihatan" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('nervus2_penglihatan',$existing_data) ?></textarea>    
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <textarea name="konstriksi_pupil" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('konstriksi_pupil',$existing_data) ?></textarea>    
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <textarea name="gerakan_kelopak" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('gerakan_kelopak',$existing_data) ?></textarea>    
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <textarea name="gerakan_bola_mata" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('gerakan_bola_mata',$existing_data) ?></textarea>    
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <textarea name="gerakan_mata_bawah" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('gerakan_mata_bawah',$existing_data) ?></textarea>    
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="refleks_dagu" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('refleks_dagu',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <textarea name="refleks_cornea" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('refleks_cornea',$existing_data) ?></textarea>    
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="pengecapan_depan" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('pengecapan_depan',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="fungsi_pendengaran" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('fungsi_pendengaran',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="refleks_menelan" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('refleks_menelan',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="refleks_muntah" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('refleks_muntah',$existing_data) ?></textarea>
                                </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-2 col-form-label">
                            ...
                            <div class="col-sm-10">
                                <textarea name="pengecapan_belakang" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('pengecapan_belakang',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="suara_pasien" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('suara_pasien',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="gerakan_kepala" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('gerakan_kepala',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="angkat_bahu" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('angkat_bahu',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="deviasi_lidah" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('deviasi_lidah',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="kaku_kuduk" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('kaku_kuduk',$existing_data) ?></textarea>
                                </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="kernig_sign" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('kernig_Sign',$existing_data) ?></textarea>
                               </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="refleks_brudzinski" class="form-control"
                        rows="3" style="overflow:hidden; resize:none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"
                        <?= $ro ?>><?= val('refleks_brudzinski',$existing_data) ?></textarea>
                                </div>
                        </div>
