        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="tgl_keluar_dok" name="tgl_keluar_dok" required readonly value="<?= $row['tgl_keluar_dok']; ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tujuan" name="tujuan" required readonly value="<?= $row['tujuan']; ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <?php if (!empty($row['file'])) : ?>
                                <p><a href="dokumen_pendukung/uploads/<?php echo $row['file']; ?>" target="_blank"><?php echo $row['file']; ?></a></p>
