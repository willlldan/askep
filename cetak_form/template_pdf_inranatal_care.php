...
<body>
    <div>
        ...
        <!-- ================================ -->
        <!-- SECTION: LAPORAN PENDAHULUAN -->
        <!-- ================================ -->
        <h3 class="mt-5">Laporan Pendahuluan</h3>

        <h4>A. Konsep Dasar Medis</h4>
        <div class="field-row">
            <div class="field-label">Pengertian Persalinan</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['pengertian_persalinan']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Tanda – Tanda Persalinan</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['tanda_persalinan']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Onset Persalinan</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['onset_persalinan']) ?></div>
        </div>

        <h4>Tahapan Persalinan</h4>
        <div class="field-row">
            <div class="field-label">Kala I</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['tahapan_kala1']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Kala II</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['tahapan_kala2']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Kala III</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['tahapan_kala3']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Kala IV</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['tahapan_kala4']) ?></div>
        </div>

        <h4>Mekanisme Persalinan</h4>
        <div class="field-row">
            <div class="field-label">Engagement</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['mekanisme_engagement']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Desensus</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['mekanisme_desensus']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Fleksi</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['mekanisme_fleksi']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Rotasi Internal</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['mekanisme_rotasi_internal']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Ekstensi</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['mekanisme_ekstensi']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Rotasi Eksternal</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['mekanisme_rotasi_eksternal']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Ekspulsi</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['mekanisme_ekspulsi']) ?></div>
        </div>
        ...
        <div class="field-row">
            ...
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['faktor_power']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Passage</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['faktor_passage']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Passenger</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['faktor_passenger']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Psikologi</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['faktor_psikologi']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Posisi</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['faktor_posisi']) ?></div>
        </div>

        <h4>B. Konsep Keperawatan</h4>
        <div class="field-row">
            <div class="field-label">Pengkajian Kala I</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['pengkajian_kala1']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Pengkajian Kala II</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['pengkajian_kala2']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Pengkajian Kala III</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['pengkajian_kala3']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Pengkajian Kala IV</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['pengkajian_kala4']) ?></div>
        </div>
        ...
        <div class="field-row">
            <div class="field-label">Kala I</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['diagnosa_kala1']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Kala II</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['diagnosa_kala2']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Kala III</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['diagnosa_kala3']) ?></div>
        </div>
        <div class="field-row">
            <div class="field-label">Kala IV</div>
            <div class="field-sep">:</div>
            <div class="field-value"><?= p($laporan_pendahuluan['diagnosa_kala4']) ?></div>
        </div>
