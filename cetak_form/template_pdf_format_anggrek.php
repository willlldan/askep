...
<div class="field-row">
    ...
    <div class="field-value"><?= p($fisik['terapi']) ?></div>
        ...
        <!-- ================================ -->
        <h3 class="mt-5">Diagnosa Keperawatan Prioritas</h3>
        <table class="data">
            <thead>
                <tr>
                    <th width="5%">No.</th>
        ...
        <h3 class="mt-5">Rencana Keperawatan</h3>
        <table class="data">
            <thead>
                <tr>
                    <th width="5%">No.</th>
                ...
                <?php if (!empty($lainnya['implementasi'])): ?>
                    <?php foreach ($lainnya['implementasi'] as $impl): ?>
                        <tr>
                            ...
                            <td><?= p($impl['jam']) ?></td>
                            <td style="white-space: pre-wrap;"><?= nl2br(p($impl['implementasi_hasil'])) ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                ...
                <?php if (!empty($lainnya['evaluasi'])): ?>
                    <?php foreach ($lainnya['evaluasi'] as $eval): ?>
                        <tr>
                            ...
                            <td><?= p($eval['jam']) ?></td>
                            <td style="white-space: pre-wrap;"><?= nl2br(p($eval['evaluasi_soap'])) ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
