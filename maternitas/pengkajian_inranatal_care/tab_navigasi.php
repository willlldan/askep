...
<?php if($prevTab): ?>
<a href="index.php?page=maternitas/pengkajian_inranatal_care&tab=<?= $prevTab ?>" class="btn btn-secondary">
Sebelumnya
</a>
<?php else: ?>
<div></div>
...
<?php if($nextTab): ?>
<a href="index.php?page=maternitas/pengkajian_inranatal_care&tab=<?= $nextTab ?>" class="btn btn-primary">
Selanjutnya
</a>
<?php endif; ?>
