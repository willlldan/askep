              ...
              <h5 class="card-title mb-1"><strong>Pengkajian</strong></h5>
                ...
                <!-- Bagian Kepala dan Rambut -->
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentinspekkonjungtiva" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentinspeksidada" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpalpasidada" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentauskultasidada" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                   ...
                   <!-- Bagian Sistem Kardiovaskuler -->
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentinspeksidanpalpasisistem" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Auskultasi Suara Jantung -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentauskultasisistem" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Masalah Khusus -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentmasalahkhusussistem" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentinspeksipengeeluarancairan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <!-- Bagian Abdomen -->
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpendarahan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commenthemoroid" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Keputihan -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentkeputihan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Masalah Khusus -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentmasalahkhususgenetalia" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <!-- Bagian Eliminasi -->
                    ...
                    <!-- Masalah Khusus -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentmasalahkhususbak" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Masalah Khusus -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentmasalahkhususbab" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
