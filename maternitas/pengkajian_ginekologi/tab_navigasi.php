...
<?php if($prevTab): ?>
<a href="index.php?page=maternitas/pengkajian_ginekologi&tab=<?= $prevTab ?>" class="btn btn-secondary">
Sebelumnya
</a>
<?php else: ?>
<div></div>
...
<?php if($nextTab): ?>
<a href="index.php?page=maternitas/pengkajian_ginekologi&tab=<?= $nextTab ?>" class="btn btn-primary">
Selanjutnya
</a>
<?php endif; ?>
