        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <!-- comment -->
                            <textarea class="form-control mt-2" id="commentriwayatpersalinan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <!-- comment -->
                            <textarea class="form-control mt-2" id="commentjumlahpendarahan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <!-- comment -->
                            <textarea class="form-control mt-2" id="commentbbtbbayi" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <!-- comment -->
                            <textarea class="form-control mt-2" id="commentmenyusui" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
            ...
            <div class="card-body">
                ...
                <!-- Bagian Data Biologis/Fisiologis -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentbiologisfisiologis" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <!-- Bagian Bayi Rawat Gabung -->
                    <div class="row mb-3">
                        ...
                        <select class="form-select" name="bayirawatgabung">
                         ...
                         <!-- comment -->
                        <textarea class="form-control mt-2" id="commentbayirawatgabung" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Bagian Jika Tidak Ada Alasan -->
                        ...
                        <!-- comment -->
                            <textarea class="form-control mt-2" id="commenttidakadaalasan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
              ...
              <h5 class="card-title mb-1"><strong>Pengkajian</strong></h5>
                ...
                <!-- Bagian Kepala dan Rambut -->
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentinspeksimata" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentcolostum" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <!-- Inspeksi Tanda Pembengkakan -->
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentinspeksipembengkakan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <!-- Bagian Abdomen -->
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentinspeksiabdomen" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentauskultasibisingusus" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentperkusi" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpalpasiinvolusi" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpalpasikandungkemih" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentperineum" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentredness" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentedema" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentapproximate" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commenthemorrhoid" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentdatatambahan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <!-- Bagian Pola Nutrisi dan Cairan -->
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentjenismakanan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentfrekuensi" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentkonsumsisnack" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentnafsumakan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpolaminum" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentfrekuensi2" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpantanganmakanan" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                ...
                <!-- Pengetahuan Menyusui -->
                    ...
                    <!-- Kemampuan Menyusui -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentkemampuanmenyusui" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Posisi Menyusui -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentposisimenyusui" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Penyimpanan Asi -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpenyimpananasi" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Perawatan Payudara -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentperawatanpayudara" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Produksi ASI -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentproduksiasi" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                 ...
                 <!-- Kontrasepsi -->
                    ...
                    <!-- Jenis KB -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentjeniskb" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Pengetahuan KB -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentpengetahuankb" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
                    ...
                    <!-- Rencana Penggunakan KB -->
                     ...
                     <!-- comment -->
                            <textarea class="form-control mt-2" id="commentrencanapenggunaankb" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                            oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';" readonly></textarea>
                        </div>
