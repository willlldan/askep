        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-2"><strong>Bunyi Nafas Abnormal</strong>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="kelainan_paru" value="<?= htmlspecialchars($existing_data['kelainan_paru'] ?? '') ?>" <?= $ro ?>>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="kelainan_jantung" value="<?= htmlspecialchars($existing_data['kelainan_jantung'] ?? '') ?>" <?= $ro ?>>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-2"><strong>Refleks lipat paha</strong>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-2 col-form-label">
                                <strong>Laboratorium,radiologi,dll</strong>
                            </div>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="lab" value="<?= htmlspecialchars($existing_data['lab'] ?? '') ?>" <?= $ro ?>>
