...
<main id="main" class="main">
   ...
   <li class="nav-item">
    ...
    <section class="section dashboard">
        <div class="card">
            <div class="card-body">
              <h5 class="card-title mb-1"><strong>Diagnosa Keperawatan Prioritas</strong></h5>
                ...
                <!-- Bagian Data -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                           <textarea name="data" class="form-control" rows="3" cols="30" style="display:block; overflow:hidden; resize: none;" oninput="this.style.height='auto'; this.style.height=this.scrollHeight+'px';"></textarea>

                     <!-- comment -->
                            <textarea class="form-control mt-2" name="commentdata" id="commentdata" rows="2" placeholder="Kolom ini menampilkan revisi dari dosen. Jika ada revisi, tetap semangat mengerjakannya!" style="display:block; overflow:hidden; resize: none;"
                ...
                <!-- Bagian Button -->    
                    ...
                    if(!empty($data)){
                        foreach($data as $row){
                            ...
                            <td>".$no++."</td>
                            <td>".$row['data']."</td>
                            <td>".$row['diagnonsakeperawatan']."</td>
                            <td>".$row['paraf']."</td>
                            </tr>";
                        }
                    }
